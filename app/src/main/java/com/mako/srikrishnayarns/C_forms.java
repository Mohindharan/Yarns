 ...
 */
public class C_forms extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        cc =new formadapter(dataset,mDatakey,getActivity(),"cform");
    ...
    private void loadData() {
        ...
        mDatabase.orderByChild("cform").equalTo(false).addValueEventListener(new ValueEventListener() {
            @Override
